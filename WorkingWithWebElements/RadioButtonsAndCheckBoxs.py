...
class RadioButtonsAndCheckboxes():
    def test(self):
        ...
        print("BMW Radio button is selected? " + str(
            bmwRadioBtn.is_selected()))  # True if selected, False is not selected
...
radioButtonsAndCheckboxes = RadioButtonsAndCheckboxes()
radioButtonsAndCheckboxes.test()
